...
const FeedbackForm = () => {
  ...
  useEffect(() => {
    baseClient.get(`shipment/${id}/review`)
      .then((response) => {
...

      {
        rresponse?.can_review && (
          <>
            ...
            <p className="text-gray-600 mb-4">How was your experience with {rresponse?.shipment?.accepted_bid[0].bidder?.name}?</p>
            ...
            <div className="flex space-x-4">
              ...
              <button
                className="bg-gray-500 text-white rounded-lg py-2 px-6 hover:bg-gray-700 transition-colors"
              >
                Cancel
              </button>
            </div>
          ...
          <article>
            <div className="flex items-center mb-4">
              <div className="font-medium dark:text-white">
                <p><time className="block text-sm text-gray-500 dark:text-gray-400">{rresponse?.shipment?.reviews[0].created_at}</time></p>
              </div>
            </div>
            ...
            <p className="mb-2 text-gray-500 dark:text-gray-400">{rresponse?.shipment?.reviews[0].comments}</p>
